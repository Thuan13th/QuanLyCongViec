...
namespace QuanLyCongViec
{
    ...
    {
        private const string connectionString = "@Data Source=THUAN\\SQLEXPRESS;Initial Catalog=BTL1;Integrated Security=True";
        ...
        {
            DialogResult r = MessageBox.Show("Bạn có chắc muốn thoát?",
                                            "Thông báo",
